{!! Form::open(array('url'=>'procesos/cobro','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
<div class="form-group">
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-8">
      <div class="form-group">
          <span>cliente</span>
          <input type="text" class="form-control" name="searchText" placeholder="Buscar por nombres o DNI cliente" value="{{$searchText}}">
      </div> 
      <div class="form-group"> 
      <span>Analista</span>
      <input type="text" class="form-control" name="searchText2" placeholder="Buscar x Analista" value="{{$searchText2}}">
      </div>
