{!! Form::open(array('url'=>'procesos/credito','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
<div class="row"> 
      ...
      <div class="col-lg-3 col-sm-6 col-md-8 col-xs-12">
          <div class="input-group">
             <input type="text" class="form-control" name="searchText" placeholder="Buscar DNI/RUC " value="{{$searchText}}">             
...
<div class="row"> 
  <div class="col-lg-3 col-sm-6 col-md-8 col-xs-12">
     <div class="input-group">
        <input type="date" class="form-control" id="fechaInicial" name="fechaInicial" data-toggle="tooltip" title="Fecha inicial" max=<?php echo date('Y-m-d'); ?> value={{old('fechaInicial')}} />
       <span class="input-group-btn">
   ...
   <div class="col-lg-3 col-sm-6 col-md-8 col-xs-12">
     <div class="input-group">
         <input type="date" class="form-control" id="fechaFinal" name="fechaFinal" data-toggle="tooltip" title="Fecha final" max=<?php echo date('Y-m-d'); ?> value={{old('fechaFinal')}}/>
       <span class="input-group-btn">
