<?php echo Form::open(array('url'=>'procesos/caja','method'=>'GET','autocomplete'=>'off','role'=>'search')); ?>
...
<?php $__env->startPush('scripts'); ?> <!-- Trabajar con el script definido en el layout-->
<script>
