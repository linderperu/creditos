<?php $__env->startSection('contenido'); ?>
                ...
                <h2>En caja: (S/) <?php echo e($query3); ?></h2>
                <div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<?php endif; ?>
                        ...
                        <?php echo Form::open(array('url'=>'procesos/credito','method'=>'POST','autocomplete'=>'off')); ?>
...
<div class="row" >
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-8">  
                        ...
                        <option value="<?php echo e($per->idpersona); ?>"><?php echo e($per->nombres); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                
                        </select> 
                        <label for="empleado">Quien otorga el credito</label>                                
                        <select id="empleado" name="idempleado" class="form-control input-lg">
                        <?php $__currentLoopData = $empleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $per): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($per->idrol!='2'): ?>                       
...
<div class="row">
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                ...
                <input type="hidden" name="idcajero" value=<?php echo e(auth()->user()->id); ?> class="form-control ">
...
<div class="form-group">
        ...
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-8">
         ...
         <!--   <input type="date" class="form-control btn-lg" name="fechapcuota" id="fechapcuota" placeholder="DD/MM/AA" required min=<?php $hoy=date("Y-m-d"); echo $hoy;?> value=<?php echo date('Y-m-d'); ?> >  !--> 
                ...
                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-default btn-lg">Volver</a>
        </div>        
